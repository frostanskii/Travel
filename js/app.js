...
if (document.querySelector('.slider-photos__body')) {
	new Swiper('.slider-photos__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 37,
		...
		// Arrows
		navigation: {
			nextEl: '.slider-photos__arrows .photos-arrows__next',
			prevEl: '.slider-photos__arrows .photos-arrows__prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
